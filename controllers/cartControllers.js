...
exports.addToCart = async (req, res) => {
    try {
        ...
        const existingItemIndex = userCart.items.findIndex(item => item.menuItem.toString() === menuItemId);
...
exports.removeFromCart = async (req, res) => {
    try {
        ...
        const itemIndex = userCart.items.findIndex(item => item.menuItem.toString() === menuItemId);
